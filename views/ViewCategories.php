					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
									...
									<ul class="dropdown-menu multi-column columns-3">
										...
										<div class="col-sm-3 multi-gd-img">
											...
											<div class="col-sm-6 multi-gd-img multi-gd-text ">
												<a href="index.php?controller=men"><img src="assets/frontend/images/woo.jpg" alt=" " /></a>
											</div>
								...
								<li class="dropdown menu__item">
									<a href="index.php?controller=women" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">women's wear <span class="caret"></span></a>
									<ul class="dropdown-menu multi-column columns-3">
										<div class="row">
											<div class="col-sm-3 multi-gd-img">
												<ul class="multi-column-dropdown">
